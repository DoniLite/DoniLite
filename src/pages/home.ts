...
export const home = (nav?: Component, children?: Component) => {
    return `
    <div class=" h-screen flex justify-center items-center w-full p-2">
        ${nav ? nav : ''}
        <div class="w-full">
            <div class="w-full">
                <div 
                    class=" w-full h-screen items-center grid grid-cols-[40%_60%]"
                >
                    <div class=" w-full h-full flex items-center">
                        <div class=" w-full">
                            <h1 class=" text-orange-500 font-bold text-9xl dancing-script">Doni</h1>
                            <h1 class="text-white font-bold text-9xl relative left-0 lg:left-[50%] dancing-script">Lite</h1>
                            <h2 class="font-bold">I build things that make the world a better place. Discover my journey and experience through my projects and achievements</h2>
                        </div>
                    </div>
                    <div class=" w-full flex justify-center relative">
                        <svg 
                            ...
                            viewBox="0 0 448 512"
                            class=" absolute w-16 h-16 fill-orange-500 transform transition-all -rotate-12 top-4 left-2"
                        >
                            <path
