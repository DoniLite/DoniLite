...
import type { Article, ArticleTranslation, EntryType } from '~~/shared/types'
...
export const mockArticles: Article[] = [
  {
    ...
    featured: true,
    views: 10000,
    tags: [{ id: 'typescript', label: 'TypeScript', slug: 'typescript' }],
    translations: [],
    en: {
      locale: 'en',
  ...
  },
  {
    ...
    featured: false,
    views: 342,
    tags: [{ id: 'vue', label: 'Vue.js', slug: 'vue' }],
    translations: [],
    en: {
      locale: 'en',
  ...
  },
  {
    ...
    featured: false,
    views: 90000,
    tags: [{ id: 'rust', label: 'Rust', slug: 'rust' }],
    translations: [],
    en: {
      locale: 'en',
      translationStatus: 'reviewed',
...
const isArticleTranslation = (
  translation: ArticleTranslation | undefined
): translation is ArticleTranslation => Boolean(translation)

mockArticles.forEach((article) => {
  article.translations = [article.en, article.fr].filter(isArticleTranslation)
})
...
/* --- SCATTER PLOT DATA --- */
const scatterCategories = ['Vue.js', 'TypeScript', 'Nuxt', 'Open Source'] as const

export const mockScatterData = Array.from({ length: 50 }, (_) => ({
  x: Math.random() * 100,
  y: Math.random() * 100,
  size: Math.random() * 20 + 5,
  category: scatterCategories[Math.floor(Math.random() * scatterCategories.length)] ?? 'Vue.js'
}))
